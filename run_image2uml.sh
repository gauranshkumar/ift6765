#!/bin/bash
# ==========================================================
# Image → UML Experiment Execution Script
# ==========================================================
# Prerequisites:
#   - vLLM server running (started by setup_vllm.sh)
#   - Project checked out at BASE_DIR
#
# Environment variables (set by image2uml_exp.sh):
...
echo "=========================================="
echo "Image → UML Experiment Configuration"
echo "=========================================="
...
# ==========================================================
# 1) Load modules needed for the experiment
# ==========================================================
...
LOG_FILE="$LOG_DIR/image2uml_${TIMESTAMP}.log"

echo "=========================================="
echo "Running image2uml.py..."
echo "Log: $LOG_FILE"
echo "=========================================="

cd "$BASE_DIR"

if python image2uml.py 2>&1 | tee -a "$LOG_FILE"; then
    echo "=========================================="
    ...
    EXIT_CODE=$?
    echo "=========================================="
    echo "[ERROR] image2uml.py failed (exit code: $EXIT_CODE)"
